DROP TRIGGER IF EXISTS `calvert_grade_before_update`;

CREATE TRIGGER `calvert_grade_before_update` BEFORE
UPDATE
	ON `calvert_grade` FOR EACH ROW # subtract old credit hours and grade points
	BEGIN
UPDATE
	calvert_student
SET
